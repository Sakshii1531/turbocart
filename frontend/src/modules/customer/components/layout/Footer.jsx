        ...
        <footer className="relative bg-[#051108] pt-20 pb-10 mt-20 text-slate-300 md:bg-gradient-to-br md:from-brand-700 md:via-brand-800 md:to-brand-900 md:pt-32 md:pb-16 md:mt-32 overflow-hidden">
            ...
            <div className="container mx-auto px-4 z-10 relative">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-16">
                    ...
                    <div className="space-y-4 md:space-y-8">
                        <div className="flex items-center">
                            {logoUrl
                                ? <img src={logoUrl} alt={`${appName} Logo`} loading="lazy" className="h-12 md:h-16 w-auto object-contain" />
                                : <span className="text-white font-black text-2xl tracking-tight">{appName}</span>
                            }
                        </div>
                    ...
                    <div className="md:pt-4">
                        ...
                        <ul className="space-y-2 md:space-y-4">
                            ...
                            <li><Link to="/offers" className="hover:text-brand-300 transition-colors md:text-base md:font-semibold flex items-center group text-white"><span className="hidden md:block w-0 h-px bg-white group-hover:w-4 group-hover:mr-2 transition-all"></span>Offers</Link></li>
                            <li><Link to="/support" className="hover:text-brand-300 transition-colors md:text-base md:font-semibold flex items-center group text-white"><span className="hidden md:block w-0 h-px bg-white group-hover:w-4 group-hover:mr-2 transition-all"></span>Support & Contact</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="md:pt-4">
                        ...
                        <ul className="space-y-2 md:space-y-4">
                            <li><Link to="/categories" className="hover:text-brand-300 transition-colors md:text-base md:font-semibold flex items-center group text-white"><span className="hidden md:block w-0 h-px bg-white group-hover:w-4 group-hover:mr-2 transition-all"></span>Fruits & Vegetables</Link></li>
                            <li><Link to="/categories" className="hover:text-brand-300 transition-colors md:text-base md:font-semibold flex items-center group text-white"><span className="hidden md:block w-0 h-px bg-white group-hover:w-4 group-hover:mr-2 transition-all"></span>Dairy Products</Link></li>
                            <li><Link to="/categories" className="hover:text-brand-300 transition-colors md:text-base md:font-semibold flex items-center group text-white"><span className="hidden md:block w-0 h-px bg-white group-hover:w-4 group-hover:mr-2 transition-all"></span>Meat & Fish</Link></li>
                            <li><Link to="/categories" className="hover:text-brand-300 transition-colors md:text-base md:font-semibold flex items-center group text-white"><span className="hidden md:block w-0 h-px bg-white group-hover:w-4 group-hover:mr-2 transition-all"></span>Bakery & Snacks</Link></li>
                            <li><Link to="/categories" className="hover:text-brand-300 transition-colors md:text-base md:font-semibold flex items-center group text-white"><span className="hidden md:block w-0 h-px bg-white group-hover:w-4 group-hover:mr-2 transition-all"></span>Beverages</Link></li>
                        </ul>
                    </div>
                ...
                <div className="border-t border-white/10 mt-12 pt-8 text-center text-sm md:flex md:justify-between md:text-left md:mt-24 md:pt-12">
                    ...
                    <div className="flex flex-wrap gap-4 md:gap-8 justify-center md:justify-end mt-4 md:mt-0">
                        ...
                        <Link to="/refund-policy" className="hover:text-brand-300 md:text-base text-white/60 transition-all">Refund Policy</Link>
                        <Link to="/delivery-policy" className="hover:text-brand-300 md:text-base text-white/60 transition-all">Delivery Policy</Link>
                    </div>
                </div>
            </div>
        </footer>
